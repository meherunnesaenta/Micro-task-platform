...
const Banner = () => {
  ...
  return (
    <div className="relative w-full h-screen max-h-[600px] md:max-h-[650px] lg:max-h-[700px] overflow-hidden bg-base-100">
      <Swiper
                ...
                <div className="container-modern">
                  <div className="max-w-2xl animate-fade-in-up" style={{ animationDelay: `${index * 0.2}s` }}>
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/20 mb-4 md:mb-6">
                      ...
                      <span className="text-sm font-medium text-white">New Opportunity</span>
                    </div>
                    ...
                    {/* Subtitle */}
                    <p className="text-base sm:text-lg md:text-xl text-white/80 mb-6 md:mb-8 leading-relaxed max-w-xl">
                      {banner.subtitle}
                    </p>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 rounded-field font-semibold text-base sm:text-lg bg-primary text-white hover:bg-primary/90 transition-all duration-300 group"
                    >
                      {banner.buttonText}
                    ...
                    {/* Stats Row */}
                    <div className="flex flex-wrap gap-6 mt-8 md:mt-12 pt-4 border-t border-white/20">
                      <div>
                        <p className="text-2xl font-bold text-white">10K+</p>
                        <p className="text-xs text-white/60">Active Workers</p>
                      </div>
                      <div>
      ...
      <button 
        className="banner-prev absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-pointer group"
      ...
      <button 
        className="banner-next absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-pointer group"
